...
<head>
	...
	<title>マイアカウントの編集:LegendCMS</title>
		...
		<div id="mainContent">
			...
			<div id="mainContentInner">
				...
				<div class="section">
					...
					<div id="topichAreaL">
						...
						<div id="topichAreaR">
							...
							<div id="topichArea">
								...
								<h3><img src="../images/h_myaccount.jpg" width="149" height="18" alt="マイアカウントの編集" /></h3>
					...
					<form action="sub_edit.php" method="post" class="accountEdit">
						
						<input type="hidden" id="edit_type" name="edit_type" value="name" />
					
						<dl class="editArea">
							<dt><label for="user_name">アカウント名</label></dt>
								<dd><input type="text" id="user_name" name="user_name" value='<?php print $login_name; ?>' /></dd>
						</dl>
			...
			<li>
				<dl>
					<dt><img src="../images/h_menu_account.jpg" alt="アカウント" width="150" height="30" /></dt>
						<dd id="active"><a href="index.php">マイアカウントの編集</a></dd>
